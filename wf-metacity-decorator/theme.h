...
void meta_update_button_layout (const char *value, MetaButtonLayout *new_layout);
gboolean meta_get_button_position (gint    button_id,
                                  MetaFrameGeometry *fgeom,
		                          gint    *x,
		                          gint    *y,
		                          gint    *w,
		                          gint    *h);
MetaButtonType meta_function_to_type (MetaButtonFunction function);
